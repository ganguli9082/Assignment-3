	...
	public static void main(String[] args) {
		...
		//State change of elevator at different floors
				String[] Elevator = {
						...
						"Level 1 button was pushed",
						"Level 2 Button was pushed",
									};
				//Possible values for elevator at basement
				String[] Basement = {
						"1 was pushed, Elevator is closed, elevator is going up 1 floor, elevator is at level 1, elevator is open",
						"2 was pushed, Elevator is closed, elevator is going up 2 floors, elevator is at level2, elevator is open",
									};
				//Possible values for elevator at Level 1
				String[] Level1 = {
						"0 was pushed, Elevator is closed, elevator is going down 1 floor, elevator is at level B, elevator is open",
				...
				if (index !=0) 
						{
							for (;floor > 0; floor--) 
								System.out.println("Elevator is going up 1 floor. Elevator is now at " + (level ++));
						};
				
						
				System.out.println("Elevator door is open");		
				
				//level destination input
